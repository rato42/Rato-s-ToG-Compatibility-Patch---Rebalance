...
function RatoTOG_Patch()
    ...
    PKM_1.ComponentSlots = {
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'BarrelNormal', 'BarrelNormalImproved', 'R_TOG_light_barrel'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Magazine',
            ...
            Modifiable = false,
            AvailableComponents = {
                'MagNormal', 'MagNormalFine', 'MagQuick', 'MagLarge'
            }
        }, {
            CanBeEmpty = true,
            SlotType = 'Scope',
            Modifiable = true,
            AvailableComponents = {
                'LROptics', 'ReflexSight', 'ScopeCOG', 'ThermalScope',
                'LROpticsAdvanced', 'ScopeCOGQuick', 'ReflexSightAdvanced',
    ...
    M76_1.ComponentSlots = {
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'm76_stock_erg_1', 'm76_stock_def_1', 'm76_stock_hvy_1'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Magazine',
            ...
            Modifiable = true,
            AvailableComponents = {
                'ImprovisedSuppressor', 'RAT_TOG_suppressor',
                'RAT_TOG_compensator', 'ToG_VFX_Muzzle'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Scope',
            ...
            Modifiable = true,
            AvailableComponents = {
                'RAT_TOG_Reflex_rpk_mount', 'RAT_TOG_ACOG_rpk_mount',
                'RAT_TOG_compactRS_rpk_mount', 'RAT_TOG_Prism_rpk_mount',
                'RAT_TOG_vigilanceRS_rpk_mount', 'RAT_TOG_thermal_rpk_mount',
                'RAT_TOG_WideScope_rpk_mount', 'RAT_TOG_LRoptics_rpk_mount',
                'm76_scope_1', 'RAT_TOG_LRoptics_advanced_rpk_mount',
                'ImprovedIronsight'
            }
        }, {
            CanBeEmpty = false,
            ...
            Modifiable = true,
            AvailableComponents = {
                'm76_barrel_shrt_1', 'm76_barrel_def_1', 'm76_barrel_ext_1'
            }
        }
    }
    M76_1.CritChance = 0
    ...
    RPD_1.ComponentSlots = {
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'LROptics', 'ReflexSight', 'ScopeCOG', 'LROpticsAdvanced',
                'ScopeCOGQuick', 'ReflexSightAdvanced', 'RPD_ironsight_1',
                'WideScope', '_ReflexSIghtVigilance', 'ThermalScope'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Muzzle',
            ...
            Modifiable = true,
            AvailableComponents = {
                'ToG_VFX_Muzzle', 'RAT_TOG_compensator', 'RAT_TOG_suppressor'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Stock',
    ...
    HK23ECamo_1.ComponentSlots = {
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'hk23e_barrel_shrt_1', 'hk23e_barrel_def_1',
                'hk23e_barrel_ext_1'
            }
        }, {
            CanBeEmpty = false,
            ...
            Modifiable = true,
            AvailableComponents = {
                'hk23e_muzzle_1', 'MuzzleBooster', 'Compensator'
            }
        }, {
            CanBeEmpty = true,
            SlotType = 'Scope',
            Modifiable = true,
            AvailableComponents = {
                'RAT_TOG_Reflex', 'RAT_TOG_ACOG', 'RAT_TOG_compactRS',
                'RAT_TOG_Prism', 'RAT_TOG_vigilanceRS', 'RAT_TOG_thermal',
                'RAT_TOG_WideScope', 'RAT_TOG_LRoptics', 'RAT_TOG_PSGScope',
            ...
            Modifiable = true,
            AvailableComponents = {
                'hk23e_stock_hvy_1', 'hk23e_stock_def_1', 'hk23e_stock_erg_1'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Bipod',
    ...
    G3A3Green_1.WeaponRange = 34
    G3A3Green_1.AvailableAttacks = {
        "BurstFire", "AutoFire", "SingleShot", "CancelShot"
    }
    ...
    G3A3Green_1.ComponentSlots = {
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'G3A3_barrel_shrt_1', 'G3A3_barrel_def_1', 'G3A3_barrel_ext_1'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Muzzle',
            ...
            Modifiable = true,
            AvailableComponents = {
                'RAT_TOG_suppressor', 'ImprovisedSuppressor', 'G3A3_muzzle_1'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Magazine',
            ...
            Modifiable = true,
            AvailableComponents = {
                'G3A3_Stock_1', 'G3A3_stock_hvy_1', 'HK53_stock_unfld_1'
            }
        }
    }
    ...
    G3A3_1.LargeItem = 1
    G3A3_1.WeaponRange = 34
    G3A3_1.AvailableAttacks = {
        "BurstFire", "AutoFire", "SingleShot", "CancelShot"
    }
    ...
    SSG69_1.ComponentSlots = {
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'SSG69_Scope_1', 'ScopeCOGQuick', 'ScopeCOG', 'WideScope'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Barrel',
            ...
            Modifiable = true,
            AvailableComponents = {
                'ToG_VFX_Muzzle', 'AUGCompensator_01', 'ImprovisedSuppressor',
                'RAT_TOG_suppressor'
            }
        }, {
            CanBeEmpty = false,
    ...
    AN94_1.LargeItem = 1
    AN94_1.WeaponRange = 34
    AN94_1.AvailableAttacks = {
        "BurstFire", "AutoFire", "SingleShot", "CancelShot"
    }
    ...
    AN94_1.ComponentSlots = {
        {
            ...
            AvailableComponents = {
                ...
                'RAT_TOG_Reflex', 'RAT_TOG_compactRS', 'RAT_TOG_vigilanceRS',
                'RAT_TOG_ACOG', 'RAT_TOG_Prism', 'RAT_TOG_LRoptics',
                'RAT_TOG_WideScope', 'RAT_TOG_thermal'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Muzzle',
            ...
            Modifiable = true,
            AvailableComponents = {
                'AN94_Barrel_short_1', 'AN94_Barrel_def_1', 'AN94_Barrel_ext_1'
            }
        }
    }
    AN94_1.CritChance = 0
    ...
    HK33A2_1.ComponentSlots = {
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'hk33_barrel_shrt_1', 'hk33_barrel_def_1', 'hk33_barrel_ext_1'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Muzzle',
            ...
            Modifiable = true,
            AvailableComponents = {
                'RAT_TOG_suppressor', 'ImprovisedSuppressor', 'hk33_muzzle_1'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Magazine',
            ...
            Modifiable = true,
            AvailableComponents = {
                'hk33_magazine_11', 'hk33_magazine_31', 'hk33_drum_mag_1'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Stock',
            ...
            Modifiable = true,
            AvailableComponents = {
                'hk33_Stock_1', 'G3A3_stock_hvy_1', 'HK53_stock_unfld_1'
            }
        }, {
            CanBeEmpty = true,
            SlotType = 'Bipod',
            ...
            Modifiable = true,
            AvailableComponents = {
                'hk33_handguard_cl_1', 'hk33_handguard_new_1'
            }
        }, {
            CanBeEmpty = true,
            SlotType = 'Scope',
            ...
            Modifiable = true,
            AvailableComponents = {
                'hk33_lower_classic_1', 'hk33_lower_modern_1'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Side2',
            ...
            Modifiable = true,
            AvailableComponents = {
                'ToG_Flashlight_2', 'ToG_Red_Dot_2', 'ToG_UV_Dot_2',
                'side_2_empty'
            }
        }
    }
    ...
    Mosin_1.ComponentSlots = {
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'Mosin_Scope_iron_1', 'ReflexSightAdvanced', 'ReflexSight',
                '_ReflexSIghtVigilance', 'LROptics', 'ScopeCOGQuick',
            ...
            Modifiable = true,
            AvailableComponents = {
                'ToG_VFX_Muzzle', 'ImprovisedSuppressor', 'Suppressor'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'General',
    ...
    Papovka2SKS_1.ComponentSlots = {
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'Papovka2_Grnd_fld_1', 'Papovka2_Grnd_unfld_1'
            }
        }, {
            CanBeEmpty = true,
            SlotType = 'Scope',
            Modifiable = true,
            AvailableComponents = {
                'RAT_TOG_ACOG', 'RAT_TOG_WideScope', 'RAT_TOG_LRoptics',
                'RAT_TOG_Prism', 'RAT_TOG_Reflex', 'RAT_TOG_compactRS',
                'RAT_TOG_laser_dot', 'RAT_TOG_uv_dot', 'RAT_TOG_vigilanceRS',
                'RAT_TOG_thermal', 'LROptics_DragunovDefault'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Mount',
            ...
            Modifiable = true,
            AvailableComponents = {
                'Papovka2_Barrel_def_1', 'Papovka2_Barrel_ext_1',
                'Papovka2_Barrel_shrt_1'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Stock',
            ...
            Modifiable = true,
            AvailableComponents = {
                'Papovka2_Stock_def_1', 'Papovka2_Stock_erg_1',
                'Papovka2_Stock_hvy_1'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Magazine',
    ...
    PapovkaSKS_1.ComponentSlots = {
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'Papovka_Stock_erg_1', 'Papovka_Stock_def_1',
                'Papovka_Stock_hvy_1'
            }
        }, {
            CanBeEmpty = false,
    ...
    SKS_1.ComponentSlots = {
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'RAT_TOG_compensator', 'RAT_TOG_suppressor', 'ToG_VFX_Muzzle'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Barrel',
    ...
    M1Garand_2.ComponentSlots = {
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'Compensator', 'RAT_TOG_suppressor_762', 'ToG_VFX_Muzzle'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Scope',
    ...
    SteyrScout_1.ComponentSlots = {
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'SteyrS_Barrel_def_1', 'SteyrS_Barrel_ext_1',
                'RAT_TOG_SteyrS_Barrel_ext_556', 'RAT_TOG_SteyrS_Barrel_def_555'
            }
        }, {
            CanBeEmpty = true,
            SlotType = 'Bipod',
            ...
            Modifiable = true,
            AvailableComponents = {
                'SteyrS_Scope_1', 'ReflexSight', 'ScopeCOG', 'ThermalScope',
                'ReflexSightAdvanced', 'ScopeCOGQuick', 'LROptics',
                'LROpticsAdvanced'
            }
        }, {
            CanBeEmpty = false,
            ...
            Modifiable = true,
            AvailableComponents = {
                'RAT_TOG_compensator', 'SteyrS_Muzzle_def_1', 'ToG_VFX_Muzzle'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Stock',
...
<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Faster bolt-action mechanism
    ...
    TAR21_1.LargeItem = 1
    TAR21_1.WeaponRange = 32
    TAR21_1.AvailableAttacks = {
        "BurstFire", "SingleShot", "AutoFire", "CancelShot"
    }
    ...
    TAR21_1.ComponentSlots = {
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'ImprovisedSuppressor', 'RAT_TOG_suppressor_762',
                'MuzzleBooster', 'TAR21_Muzzle_def_1'
            }
        }, {
            CanBeEmpty = true,
            SlotType = 'General',
    ...
    STG44R_1.WeaponRange = 30
    STG44R_1.AvailableAttacks = {
        "BurstFire", "SingleShot", "AutoFire", "CancelShot"
    }
    ...
    STG44R_1.ComponentSlots = {
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'STG44_Barrel_shrt_1', 'STG44_Barrel_def_1',
                'STG44_Barrel_ext_1'
            }
        }, {
            CanBeEmpty = false,
            ...
            Modifiable = true,
            AvailableComponents = {
                'STG44_Stock_hvy_1', 'STG44_Stock_def_1', 'STG44_Stock_erg_1'
            }
        }, {
            CanBeEmpty = true,
            SlotType = 'Scope',
...
<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> A relic of war]])
    ...
    RK95_1.LargeItem = 1
    RK95_1.WeaponRange = 30
    RK95_1.AvailableAttacks = {
        "BurstFire", "AutoFire", "SingleShot", "CancelShot"
    }
    ...
    RK95_1.ComponentSlots = {
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'RK95_Stock_def_1', 'RK95_Stock_shrt_1', 'RK62_Stock_hvy_1',
                'RK62_Stock_def_1', 'RK62_Stock_shrt_1'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Magazine',
            ...
            Modifiable = true,
            AvailableComponents = {
                'RK95_Handguard_shrt_1', 'RK95_Handguard_def_1',
                'RK95_Handguard_ext_1'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Scope',
            ...
            AvailableComponents = {
                'RAT_TOG_Reflex', 'RAT_TOG_ACOG', 'RAT_TOG_compactRS',
                'RAT_TOG_Prism', 'RAT_TOG_vigilanceRS', 'RAT_TOG_thermal',
                'RAT_TOG_WideScope', 'RAT_TOG_LRoptics',
            ...
            Modifiable = true,
            AvailableComponents = {
                'RK95_Muzzle_def_1', 'MuzzleBooster', 'RAT_TOG_suppressor'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Barrel',
            ...
            Modifiable = true,
            AvailableComponents = {
                'RK95_Barrel_shrt_1', 'RK95_Barrel_def_1', 'RK95_Barrel_ext_1'
            }
        }
    }
    RK95_1.CritChance = 0
    ...
    Type56A_1.ComponentSlots = {
        {
            ...
            Modifiable = false,
            AvailableComponents = {
                'Papovka2_Bolt_1', 'Papovka_Bolt_1', 'Type56A_Bolt_1',
                'Type56B_Bolt_1', 'Type56C_Bolt_1', 'Type56D_Bolt_1'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Mount',
            ...
            Modifiable = true,
            AvailableComponents = {
                'Type56A_Barrel_shrt_1', 'Type56A_Barrel_def_1',
                'Type56A_Barrel_ext_1'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Stock',
            ...
            Modifiable = true,
            AvailableComponents = {
                'Type56A_stock_erg_1', 'Type56A_stock_def_1',
                'Type56A_stock_hvy_1'
            }
        }, {
            CanBeEmpty = false,
    ...
    Type56B_1.ComponentSlots = {
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'Type56B_Barrel_shrt_1', 'Type56B_Barrel_def_1',
                'Type56B_Barrel_ext_1'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Stock',
            ...
            Modifiable = true,
            AvailableComponents = {
                'Type56B_stock_erg_1', 'Type56B_stock_def_1',
                'Type56B_stock_hvy_1'
            }
        }, {
            CanBeEmpty = false,
    ...
    Type56C_1.ComponentSlots = {
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'Type56C_Barrel_shrt_1', 'Type56C_Barrel_def_1',
                'Type56C_Barrel_ext_1'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Stock',
            ...
            Modifiable = true,
            AvailableComponents = {
                'Type56C_stock_erg_1', 'Type56C_stock_def_1',
                'Type56C_stock_hvy_1'
            }
        }, {
            CanBeEmpty = false,
    ...
    Type56D_1.ComponentSlots = {
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'Type56D_Barrel_shrt_1', 'Type56D_Barrel_def_1',
                'Type56D_Barrel_ext_1'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Stock',
            ...
            Modifiable = true,
            AvailableComponents = {
                'Type56D_stock_erg_1', 'Type56D_stock_def_1',
                'Type56D_stock_hvy_1'
            }
        }, {
            CanBeEmpty = false,
    ...
    Groza_1.LargeItem = 1
    Groza_1.WeaponRange = 28
    Groza_1.AvailableAttacks = {
        "BurstFire", "AutoFire", "SingleShot", "CancelShot", "RunAndGun"
    }
    ...
    Groza_1.ComponentSlots = {
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'ImprovisedSuppressor', 'RAT_TOG_compensator',
                'RAT_TOG_suppressor'
            }
        }, {
            CanBeEmpty = false,
            ...
            Modifiable = true,
            AvailableComponents = {
                'BarrelNormal', 'ToG_Comp_AR_Barrel_Long_1',
    ...
    VSS_1.LargeItem = 1
    VSS_1.WeaponRange = 28
    VSS_1.AvailableAttacks = {
        "SingleShot", "CancelShot", "BurstFire", "AutoFire"
    }
    ...
    VSS_1.ComponentSlots = {
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'VSS_Ironsight_1', 'VSS_Scope_1', 'RAT_TOG_Reflex',
                'RAT_TOG_ACOG', 'RAT_TOG_LRoptics', 'RAT_TOG_LRoptics_advanced',
                'RAT_TOG_compactRS', 'RAT_TOG_Prism', 'RAT_TOG_vigilanceRS',
                'RAT_TOG_thermal'
            }
        }, {
            CanBeEmpty = true,
...
<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Silent Attacks]])
    ...
    M70D_1.LargeItem = 1
    M70D_1.WeaponRange = 28
    M70D_1.AvailableAttacks = {
        "BurstFire", "AutoFire", "SingleShot", "CancelShot"
    }
    ...
    M70D_1.ComponentSlots = {
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'RAT_TOG_compensator', 'MuzzleBooster', 'RAT_TOG_suppressor',
                'ToG_VFX_Muzzle'
            }
        }, {
            CanBeEmpty = false,
            ...
            Modifiable = true,
            AvailableComponents = {
                'M70D_barrel_shrt_1', 'M70D_barrel_def_1', 'M70D_barrel_ext_1'
            }
        }
    }
    M70D_1.CritChance = 0
    ...
    M70_1.LargeItem = 1
    M70_1.WeaponRange = 28
    M70_1.AvailableAttacks = {
        "BurstFire", "AutoFire", "SingleShot", "CancelShot"
    }
    ...
    M70_1.ComponentSlots = {
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'M70_barrel_shrt_1', 'M70_barrel_def_1', 'M70_barrel_ext_1'
            }
        }
    }
    M70_1.CritChance = 0
    ...
    RK62_1.LargeItem = 1
    RK62_1.WeaponRange = 28
    RK62_1.AvailableAttacks = {
        "BurstFire", "AutoFire", "SingleShot", "CancelShot"
    }
    ...
    RK62_1.ComponentSlots = {
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'RK62_Stock_shrt_1', 'RK62_Stock_def_1', 'RK62_Stock_hvy_1',
                'RK95_Stock_shrt_1', 'RK95_Stock_def_1'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Magazine',
            ...
            Modifiable = true,
            AvailableComponents = {
                'RK62_Handguard_shrt_1', 'RK62_Handguard_def_1',
                'RK62_Handguard_ext_1'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Scope',
            ...
            Modifiable = true,
            AvailableComponents = {
                'RK62_Muzzle_def_1', 'MuzzleBooster', 'RAT_TOG_suppressor'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Barrel',
            ...
            Modifiable = true,
            AvailableComponents = {
                'RK62_Barrel_shrt_1', 'RK62_Barrel_def_1', 'RK62_Barrel_ext_1'
            }
        }
    }
    RK62_1.CritChance = 0
    ...
    HK53_1.LargeItem = 1
    HK53_1.WeaponRange = 28
    HK53_1.AvailableAttacks = {
        "BurstFire", "SingleShot", "CancelShot", "RunAndGun"
    }
    ...
    VSK94_1.LargeItem = 1
    VSK94_1.WeaponRange = 26
    VSK94_1.AvailableAttacks = {
        "SingleShot", "BurstFire", "CancelShot", "AutoFire", "RunAndGun"
    }
    ...
    VSK94_1.ComponentSlots = {
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'VSK94_Stock_hvy_1', 'VSK94_Pistolgrip_1',
                'VSK94_stock_unfld_1', 'VSK94_stock_fld_1'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Magazine',
            ...
            Modifiable = true,
            AvailableComponents = {
                'LROptics_DragunovDefault', 'RAT_TOG_ACOG', 'RAT_TOG_WideScope',
    ...
    P90_2.LargeItem = 1
    P90_2.WeaponRange = 24
    P90_2.AvailableAttacks = {
        "BurstFire", "AutoFire", "SingleShot", "RunAndGun", "CancelShot"
    }
    ...
    P90_2.ComponentSlots = {
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'ReflexSight', 'ReflexSightAdvanced', 'LROptics',
                'ScopeCOGQuick', 'ScopeCOG', '_ReflexSIghtVigilance',
                'WideScope'
            }
        }, {
            CanBeEmpty = false,
            ...
            Modifiable = true,
            AvailableComponents = {
                'BarrelNormal', 'ToG_Comp_AR_Barrel_Long_1_SMG',
            ...
            Modifiable = true,
            AvailableComponents = {
                'Flashlight', 'FlashlightDot', 'LaserDot', 'UVDot'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Muzzle',
            ...
            Modifiable = true,
            AvailableComponents = {
                'ToG_VFX_Muzzle', 'RAT_TOG_suppressor', 'RAT_TOG_compensator'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'General',
    ...
    PP91_1.LargeItem = 0
    PP91_1.WeaponRange = 22
    PP91_1.AvailableAttacks = {
        "BurstFire", "AutoFire", "SingleShot", "RunAndGun", "CancelShot"
    }
    ...
    PP91_1.ComponentSlots = {
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'RAT_TOG_ACOG', 'RAT_TOG_WideScope', 'RAT_TOG_Reflex',
                'RAT_TOG_compactRS', 'RAT_TOG_vigilanceRS'
            }
        }
    }
    PP91_1.CritChance = 0
    ...
    VigM2_1.LargeItem = 1
    VigM2_1.WeaponRange = 22
    VigM2_1.AvailableAttacks = {
        "BurstFire", "AutoFire", "SingleShot", "DualShot", "RunAndGun",
        "CancelShot"
    }
    ...
    VigM2_1.ComponentSlots = {
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'VigM2_Barrel_shrt_1', 'VigM2_Barrel_def_1',
                'VigM2_Barrel_ext_1'
            }
        }, {
            CanBeEmpty = false,
    ...
    UMP_1.LargeItem = 1
    UMP_1.WeaponRange = 22
    UMP_1.AvailableAttacks = {
        "BurstFire", "AutoFire", "SingleShot", "RunAndGun", "CancelShot"
    }
    ...
    UMP_1.ComponentSlots = {
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'RAT_TOG_suppressor_762', 'ImprovisedSuppressor',
                'MuzzleBooster', 'RAT_TOG_compensator'
            }
        }, {
            CanBeEmpty = true,
            SlotType = 'Side',
            ...
            AvailableComponents = {
                'ReflexSight', 'ReflexSightAdvanced', 'LROptics',
                '_ReflexSIghtVigilance', 'ScopeCOGQuick', 'ScopeCOG'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Stock',
    ...
    B93RR_1.LargeItem = 0
    B93RR_1.WeaponRange = 20
    B93RR_1.AvailableAttacks = {
        "BurstFire", "SingleShot", "DualShot", "CancelShot", "MobileShot",
        "RunAndGun"
    }
    ...
    B93RR_1.ComponentSlots = {
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'B93RR_barrel_shrt_1', 'B93RR_barrel_def_1',
                'B93RR_barrel_ext_1'
            }
        }, {
            CanBeEmpty = false,
...
<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Selective fire burst mode leads to less recoil]])
    ...
    Glock17_1.WeaponRange = 20
    Glock17_1.AvailableAttacks = {
        "SingleShot", "DualShot", "CancelShot", "MobileShot"
    }
    ...
    Glock17_1.ComponentSlots = {
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'ImprovisedSuppressor', 'Suppressor', 'ToG_VFX_Muzzle',
                'Compensator_Glock'
            }
        }, {
            CanBeEmpty = false,
            ...
            Modifiable = true,
            AvailableComponents = {
                'ToG_Comp_Pstl_defmag_1', 'ToG_Comp_Pstl_finemag_1',
                'ToG_Comp_Pstl_expmag_1', 'ToG_Comp_Pstl_ergmag_1'
            }
        }, {
            CanBeEmpty = true,
            SlotType = 'Scope',
            Modifiable = true,
            AvailableComponents = {
                'RAT_TOG_Reflex_pistol', 'RAT_TOG_compactRS',
                'ImprovedIronsight', 'RAT_TOG_vigilanceRS', 'RAT_TOG_uv_dot',
                'RAT_TOG_laser_dot'
            }
        }
    }
    ...
    P08_1.ComponentSlots = {
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'ImprovisedSuppressor', 'Suppressor', 'Compensator',
                'CAWS_Muzzle_def_1'
            }
        }
    }
...
<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Swapping to this weapon is free, as long it is not dual-wielded]])
    ...
    USP_1.LargeItem = 0
    USP_1.WeaponRange = 20
    USP_1.AvailableAttacks = {
        "SingleShot", "DualShot", "CancelShot", "MobileShot"
    }
    ...
    USP_1.ComponentSlots = {
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'BarrelNormal', 'ToG_Comp_Pstl_Barrel_Long',
...
<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Swapping to this weapon is free, as long it is not dual-wielded.]])
    ...
    VikingMP446_1.WeaponRange = 20
    VikingMP446_1.AvailableAttacks = {
        "SingleShot", "DualShot", "CancelShot", "MobileShot"
    }
    ...
    VikingMP446_1.ComponentSlots = {
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'Viking_mag_def_1', 'Viking_mag_ext_1', 'Viking_mag_extQ_1'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Barrel',
    ...
    MAC11_1.ComponentSlots = {
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'RAT_TOG_vigilanceRS', 'RAT_TOG_compactRS',
                'RAT_TOG_Reflex_pistol', 'RAT_TOG_uv_dot', 'RAT_TOG_laser_dot'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Muzzle',
    ...
    MicroUZI_1.ComponentSlots = {
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'MicroUZI_Barrel_def_1', 'MicroUZI_Barrel_ext_1'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Magazine',
...
<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Swapping to this weapon is free, as long it is not dual-wielded]])
    ...
    StenMK2_1.WeaponRange = 20
    StenMK2_1.AvailableAttacks = {
        "BurstFire", "AutoFire", "SingleShot", "RunAndGun", "CancelShot"
    }
    ...
    M1911_1.LargeItem = 0
    M1911_1.WeaponRange = 20
    M1911_1.AvailableAttacks = {
        "SingleShot", "DualShot", "CancelShot", "MobileShot"
    }
    ...
    M1911_1.ComponentSlots = {
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'RAT_TOG_suppressor', 'Compensator', 'ToG_VFX_Muzzle'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Magazine',
