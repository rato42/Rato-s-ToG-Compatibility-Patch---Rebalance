return PlaceObj('ModDef', {
	...
	'last_changes', "1.21b\n\nChanged some weapons and some components params\nFixed P08 not having mobile shot\n\nFixed a bug related to Revised Magazines compatibility: type 56s will have the model of the default magazine in its correct position",
	'dependencies', {
