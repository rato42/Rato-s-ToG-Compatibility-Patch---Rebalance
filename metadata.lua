return PlaceObj('ModDef', {
	...
	'last_changes', "1.21\n\nUMP mag size changed to 25\nUSP mag size changed to 15\nLowered recoil values of some handguns that were much higher than vanilla ones\nFixed B93 being considered a submachine gun\nPKM now has a default compensator that cant be changed. (due to model limitations)\nPP91 changed to use 9x18mm caliber. Base damage reduced to 16\n\nFixed G36 folding stock action\nSome improvements in RevMag compatibility",
	'dependencies', {
